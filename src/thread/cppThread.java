...
public class cppThread extends Thread {
	...
	public cppThread(List<String> lf,CFile totalresult) {
		super();
		this.lf = lf;
	...
	CFile result=new CFile("e:\\cppresulttest.csv");
	long totalrow=0;
	long totalvalrow=0;
	
	String wordpath="e:\\versionfunction\\cppwordlist12.txt";
	String md5path="e:\\versionfunction\\cppmd512.txt";
	String funfile="e:\\versionfunction\\cppfunction12.txt";
